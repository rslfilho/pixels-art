...
Tempo de curso: 1 mês

O objetivo desse projeto era implementar uma página web que contém uma paleta de cores funcional que poderia ser utilizada para criar desenhos em pixels. Para isto utilizamos `javascript`, `css` e `html`.
